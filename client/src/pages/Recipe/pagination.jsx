...
function Pagination(props) {
  ...
  const nextPage =
    props.page + 1 <= props.totalPage ? props.page + 1 : props.totalPage;
  ...
  return (
    <div className="nav">
      {/* First Page (<<) */}
      <Link
        to={`/recipe/${props.category}/page${1}`}
        className="PageItem"
      ...
      {/* Previous Page (<) */}
      <Link
        to={`/recipe/${props.category}/page${previousPage}`}
        className="PageItem"
      ...
      {array.map((value) => {
        let pt =
          value === "..." ? props.totalPage : value === "... " ? 1 : value;
        ...
        if (value === props.page) {
          ...
          return (
            <Link
              to={`/recipe/${props.category}/page${pt}`}
              key={value}
              className="PageItem"
      ...
      {/* Next Page (>) */}
      <Link
        to={`/recipe/${props.category}/page${nextPage}`}
        className="PageItem"
      ...
      {/* Last Page (>>) */}
      <Link
        to={`/recipe/${props.category}/page${props.totalPage}`}
        className="PageItem"
